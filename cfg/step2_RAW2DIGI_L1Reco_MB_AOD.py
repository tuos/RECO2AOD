...
# with command line options: step2 --conditions auto:run1_data -s RAW2DIGI,L1Reco,RECO,ALCA:SiStripCalZeroBias+SiStripCalMinBias+TkAlMinBiasHI+HcalCalMinBias --process AOD -n 10 --data --eventcontent AOD --scenario HeavyIons --datatier AOD --repacked --no_exec
...
'/store/hidata/HIRun2011/HIMinBiasUPC/RAW/v1/000/181/913/F419FEAC-E410-E111-AC16-E0CB4E55365C.root',
'/store/hidata/HIRun2011/HIMinBiasUPC/RAW/v1/000/181/913/F4231B9D-F510-E111-A300-003048F118DE.root',
