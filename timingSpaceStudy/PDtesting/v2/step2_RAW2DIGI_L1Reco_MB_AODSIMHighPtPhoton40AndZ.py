...
'/store/user/tuos/HIAOD2015/timing/180815/data/outputHighPtPhoton40AndZ.root'
),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('step2_RAW2DIGI_L1Reco_MB_AODSIMHighPtPhoton40AndZ.root'),
