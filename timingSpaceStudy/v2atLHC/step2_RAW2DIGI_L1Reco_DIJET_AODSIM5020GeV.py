...
process.maxEvents = cms.untracked.PSet(
    output = cms.untracked.int32(62)
)

# Input source
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
'file:/afs/cern.ch/work/m/mnguyen/public/mcDigiForAOD/step2_DIGI_L1_DIGI2RAW_HLT_RAW2DIGI_L1Reco_ncollFilt_5020.root'
),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('step2_RAW2DIGI_L1Reco_DIJET_AODSIM5020GeV62events.root'),
