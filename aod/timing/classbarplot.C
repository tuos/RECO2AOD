...
private: 
    string reportName;
    double perEventTiming;
    double perVisitTiming;
    string moduleName;

public:
    void SetReportName(string reportName0) { reportName = reportName0; }
    void SetPerEventTiming(double perEventTiming0) { perEventTiming = perEventTiming0; }
    void SetPerVisitTiming(double perVisitTiming0) { perVisitTiming = perVisitTiming0; }
    void SetModuleName(string moduleName0) { moduleName = moduleName0; }

    string GetReportName() { return reportName; }
    double GetPerEventTiming() { return perEventTiming; }
    double GetPerVisitTiming() { return perVisitTiming; }
